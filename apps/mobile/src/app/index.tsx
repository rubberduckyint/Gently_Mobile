...
export default function LoginPage() {
  ...
  const handleEmailAuth = async () => {
    ...
    setIsLoading(true);
    try {
      console.log("📱 Starting magic link request from mobile app...");
      console.log("📱 Using baseURL:", process.env.EXPO_PUBLIC_BASE_URL);
      console.log("📱 Email:", email.trim());
      
      // Use better-auth magic link with mobile-specific callback
      const result = await authClient.signIn.magicLink({
        email: email.trim(),
        callbackURL: "/auth/magic-link", // This will be our web redirect page
      });
